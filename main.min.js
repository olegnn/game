...
var i=n.prototype
return i.selectCell=function(t){return+t.target.innerText?alert("Эту клетку нельзя выбрать"):null==this.startPos?(this.startPos=+t.target.id,t.target.className="start-cell",this.stateElement.innerText="Выберите конечную клетку"):this.fillCells(this.startPos,+t.target.id)?this.checkGameOver():void 0},i.fillCells=function(t,e){var n,i,s,r
