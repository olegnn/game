...
var i=n.prototype
return i.selectCell=function(t){return+t.target.innerText?alert("Эту клетку нельзя выбрать"):null==this.startPos?(this.startPos=+t.target.id,this.stateElement.innerText="Выберите конечную клетку"):this.fillCells(this.startPos,+t.target.id)?this.checkGameOver():void 0},i.fillCells=function(t,e){var n,i,s,r
...
for(i=t;e>=i;++i)s=i,(s%this.size===e%this.size&&n||!n)&&(this.data[s]=1,r=document.getElementById(s),r.innerText=1,r.className="touched")
