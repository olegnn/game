  ...
  Game = (function(){
    ...
    prototype.selectCell = function(obj){
      ...
      if (this.startPos != null) {
        this.fillCells(this.startPos, +obj.target.id);
    ...
    prototype.fillCells = function(startPos, endPos){
      ...
      isColumn = endPos - startPos >= this.size;
      if (isColumn && (endPos - startPos) % this.size) {
        return alert("Выберите конечную клетку на одной горизонтали или вертикали с текущей клеткой");
      }
